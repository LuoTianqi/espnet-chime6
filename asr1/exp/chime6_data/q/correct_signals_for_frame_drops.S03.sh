...
( echo '#' Running on `hostname`
  ...
  echo -n '# '; cat <<EOF
/home-4/tluo9@jhu.edu/miniconda3/bin/python correct_signals_for_frame_drops.py --session=S03 chime6_audio_edits.json /data/swatana4/CHiME5/audio /data/swatana4/CHiME6/audio_tmp 
EOF
) >/scratch/groups/swatana4/tluo/espnet-4-13/egs/chime6/asr1/exp/chime6_data/correct_signals_for_frame_drops.S03.log
...
time1=`date +"%s"`
 ( /home-4/tluo9@jhu.edu/miniconda3/bin/python correct_signals_for_frame_drops.py --session=S03 chime6_audio_edits.json /data/swatana4/CHiME5/audio /data/swatana4/CHiME6/audio_tmp  ) &>>/scratch/groups/swatana4/tluo/espnet-4-13/egs/chime6/asr1/exp/chime6_data/correct_signals_for_frame_drops.S03.log
ret=$?
sync || true
time2=`date +"%s"`
echo '#' Accounting: begin_time=$time1 >>/scratch/groups/swatana4/tluo/espnet-4-13/egs/chime6/asr1/exp/chime6_data/correct_signals_for_frame_drops.S03.log
echo '#' Accounting: end_time=$time2 >>/scratch/groups/swatana4/tluo/espnet-4-13/egs/chime6/asr1/exp/chime6_data/correct_signals_for_frame_drops.S03.log
